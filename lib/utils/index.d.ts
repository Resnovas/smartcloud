...
export declare class Utils {
    ...
    api: {
        ...
        issues: {
            ...
            create: (title: string, body: string, labels: string[], assignees: string[], milestone: string) => Promise<{
                id: number;
                node_id: string;
                url: string;
                repository_url: string;
            ...
            comments: {
                ...
                create: (IDNumber: number, body: string) => Promise<{
                    id: number;
                    node_id: string;
                    url: string;
                    body?: string | undefined;
                ...
                update: (comment_id: number, body: string) => Promise<{
                    id: number;
                    node_id: string;
                    url: string;
                    body?: string | undefined;
                ...
                delete: (comment_id: number) => Promise<never>;
            };
        };
        labels: {
        ...
        project: {
            column: {
                list: (project_id: number) => Promise<{
                    url: string;
                    project_url: string;
                    cards_url: string;
                    id: number;
                ...
                listCards: (column_id: number) => Promise<{
                    url: string;
                    id: number;
                    node_id: string;
                    note: string | null;
            ...
            card: {
                ...
                create: (content_id: number, column_id: number, content_type?: 'Issue' | 'PullRequest') => Promise<{
                    url: string;
                    id: number;
                    node_id: string;
                    note: string | null;
                ...
                move: (card_id: number, column_id: number) => Promise<import("@octokit/types").OctokitResponse<{
                    [key: string]: unknown;
                }, 201>>;
            };
            projects: {
                get: (project_id: number) => Promise<{
                    owner_url: string;
                    url: string;
                    html_url: string;
                    columns_url: string;
                ...
                repo: (owner: string, repo: string) => Promise<{
                    owner_url: string;
                    url: string;
                    html_url: string;
                    columns_url: string;
        ...
        pullRequests: {
            ...
            reviews: {
                create: (IDNumber: number, body?: string, event?: Event, comments?: {
                    path: string;
                ...
                requestReviewers: (IDNumber: number, reviewers: string[]) => Promise<{
                    url: string;
                    id: number;
                    node_id: string;
                    html_url: string;
                ...
                update: (IDNumber: number, review_id: number, body: string) => Promise<{
                    id: number;
                    node_id: string;
                    user: {
                        name?: string | null | undefined;
                ...
                dismiss: (IDNumber: number, review_id: number, message: string) => Promise<{
                    id: number;
                    node_id: string;
                    user: {
                        name?: string | null | undefined;
