...
export declare function create(this: Utils, title: string, body: string, labels: string[], assignees: string[], milestone: string, ref?: string): Promise<{
    id: number;
    node_id: string;
    url: string;
...
export declare function get(this: Utils, IDNumber: number, ref?: string): Promise<{
    id: number;
    node_id: string;
    url: string;
    repository_url: string;
...
export declare const comments: {
    list(this: Utils, IDNumber: number, ref?: string): Promise<{
        id: number;
        node_id: string;
        url: string;
    ...
    get(this: Utils, comment_id: number, ref?: string): Promise<{
        id: number;
        node_id: string;
        url: string;
        body?: string | undefined;
    ...
    create(this: Utils, IDNumber: number, body: string, ref?: string): Promise<{
        id: number;
        node_id: string;
        url: string;
        body?: string | undefined;
    ...
    update(this: Utils, comment_id: number, body: string, ref?: string): Promise<{
        id: number;
        node_id: string;
        url: string;
        body?: string | undefined;
    ...
    delete(this: Utils, comment_id: number, ref?: string): Promise<never>;
};
