	...
	[7414],
	{
			...
			var p = r.createContext({}),
				...
				m = r.forwardRef(function (e, t) {
					var n = e.components,
						...
						m = u(n),
						s = o,
						y = m["".concat(p, ".").concat(s)] || m[s] || f[s] || a
					return n
						? r.createElement(y, c(c({ ref: t }, l), {}, { components: n }))
						: r.createElement(y, c({ ref: t }, l))
				})
			function s(e, t) {
				var n = arguments,
					o = t && t.mdxType
		...
		792: function (e, t, n) {
			...
			var r = n(7462),
				...
				a = (n(7294), n(3905)),
				c = ["components"],
				i = { title: "Markdown page example" },
				p = "Markdown page example",
				u = {
					type: "mdx",
					permalink: "/action-masterminds/fr/markdown-page",
