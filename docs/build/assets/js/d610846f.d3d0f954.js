	...
	[6176],
	{
		...
		6776: function (e, t, r) {
			...
			var n = r(7462),
				...
				c = void 0,
				u = {
					permalink: "/action-masterminds/blog/hello-world",
					editUrl:
					...
					tags: [
						{
							label: "hello",
							permalink: "/action-masterminds/blog/tags/hello"
						},
						{
							label: "docusaurus",
					...
					nextItem: {
						title: "Hola",
						permalink: "/action-masterminds/blog/hola"
					}
				},
				s = [],
				p = { toc: s }
			function m(e) {
				...
				return (0, a.kt)(
					...
					(0, a.kt)("p", null, "This is a test post."),
					(0, a.kt)("p", null, "A whole bunch of other information.")
				)
			}
			m.isMDXComponent = !0
		}
